...
@Component({
  selector: 'app-image-text-link-container',
  templateUrl: './image-text-link-container.component.html',
  styleUrls: ['./image-text-link-container.component.css']
})
export class ImageTextLinkContainerComponent implements OnInit {
